...
CREATE VIEW deye_Afficher_Jeux AS
SELECT * 
FROM deye_jeux;
...
DELIMITER $
CREATE PROCEDURE deye_Afficher_Jeux_Categorie_Limite_Prix (IN p_idCategorie INT)
BEGIN
SELECT * FROM deye_jeux
WHERE idCategorie = p_idCategorie
AND Prix <= p_prix;
...
#------------------------------------------------------------
# View: Afficher Evenement
#------------------------------------------------------------

CREATE VIEW deye_Afficher_Event AS
SELECT *
FROM deye_evenement;

#------------------------------------------------------------
# View: Afficher Evenement par Lieu
#------------------------------------------------------------
...
#------------------------------------------------------------
# View: Afficher Membre
#------------------------------------------------------------

CREATE VIEW deye_Afficher_Membre AS
SELECT *
FROM deye_personne;

#------------------------------------------------------------
# View: Afficher Administrateur
#------------------------------------------------------------

CREATE VIEW deye_Afficher_Administrateur AS
SELECT *
FROM deye_validateur;

#------------------------------------------------------------
# View: Afficher Utilisateur
#------------------------------------------------------------

CREATE VIEW deye_Afficher_Utilisateur AS
SELECT *
FROM deye_utilisateur;

#------------------------------------------------------------
# View: Afficher Annonce
#------------------------------------------------------------

CREATE VIEW deye_Afficher_Annonce AS
SELECT *
FROM deye_annonce;
...
CREATE VIEW deye_Afficher_Offre AS
SELECT *
FROM deye_offre;

#------------------------------------------------------------
# View: Afficher Demande
#------------------------------------------------------------

CREATE VIEW deye_Afficher_Demande AS
SELECT *
FROM deye_demande;