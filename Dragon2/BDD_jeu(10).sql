	...
	CREATE TABLE DEYE_Photo_Type(
			...
			PhotoOrigine Varchar (50) NOT NULL
	)ENGINE=InnoDB;
	...
	insert into DEYE_Photo values (null, 'A', "../img/logo.png");
	insert into DEYE_Photo values (null, 'J', "../img/trone.jpg");
	insert into DEYE_Photo values (null, 'J', "../img/monopoly.jpg");
	insert into DEYE_Photo values (null, 'J', "../img/bonne_paye.jpg");
	insert into DEYE_Photo values (null, 'J', "../img/dixit.jpg");
	#------------------------------------------------------------
	# Table: DEYE_Lieu
	#------------------------------------------------------------
	...
	insert into DEYE_Annonce values (null, 1, 1, 1, 1, 3, "NO", "Ile-de-France", "Paris", "75013", "Bon", "Jeux en bon état, sympa a jouer");
	insert into DEYE_Annonce values (null, 2, 2, 2, 2, 4, "NO", "Ile-de-France", "Paris", "75011", "Abimé", "test");
	insert into DEYE_Annonce values (null, 3, 3, 3, 6, 6, "NO", "Ile-de-France", "Paris", "75003", "Excellent", "test");
	insert into DEYE_Annonce values (null, 4, 4, 4, 4, 9, "NO", "Ile-de-France", "Paris", "75000", "Usé", "test");
	...
	#------------------------------------------------------------
	# Trigger: Changement_Type_Annonce
	#------------------------------------------------------------
