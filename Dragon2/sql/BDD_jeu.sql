...
insert into DEYE_Photo values (null, "../img/logo.png", NULL);
insert into DEYE_Photo values (null, "../img/trone.jpg", NULL);
insert into DEYE_Photo values (null, "../img/monopoly.jpg", NULL);
insert into DEYE_Photo values (null, "../img/bonne_paye.jpg", NULL);
insert into DEYE_Photo values (null, "../img/dixit.jpg", NULL);
...
insert into DEYE_Jeux values (null, "Games of Thrones" ,"2011/12/21", "54.00", "2:00:00", "6", 1, 1, 1, 1);
insert into DEYE_Jeux values (null, "Jamaica" ,"2008/02/11", "35.00", "00:30:00", "6", 2, 2, 2, 10);
insert into DEYE_Jeux values (null, "Monopoly" ,"1935/02/06", "20.00", "12:00:00", "6", 3, 6, 3, 10);
insert into DEYE_Jeux values (null, "Games of Thrones" ,"2011/12/21", "54.00", "2:00:00", "6", 4, 4, 4, 1);
insert into DEYE_Jeux values (null, "Munchkins" ,"2010/12/21", "36.00", "1:00:00", "6", 5, 5, 5, 5);
insert into DEYE_Jeux values (null, "La Bonne Paye" ,"1975/12/21", "20.00", "1:00:00", "6", 6, 6, 6, 6);
insert into DEYE_Jeux values (null, "Uno", "1971/01/01", "7.00", "00:20:00", "10", 7, 2, 3, 10);
insert into DEYE_Jeux values (null, "Labyrinthe", "1986/01/01", "20.00", "00:40:00", "4", 8, 2, 2, 2);
insert into DEYE_Jeux values (null, "Dixit", "2008/01/01", "26.90", "00:30:00", "6", 9, 2, 2, 2);
...
CREATE TRIGGER TRG_DEYE_Jeux_Archivage_After_Update AFTER UPDATE
	...
	BEGIN
		...
		(null, OLD.IdJeux, OLD.designation, OLD.date_sortie, OLD.prix, OLD.temps_jeux, OLD.nb_joueurs,
		 OLD.IdEditeur, OLD.IdAge, OLD.IdCategorie, OLD.IdPersonne, NOW());
	END $
DELIMITER ;
