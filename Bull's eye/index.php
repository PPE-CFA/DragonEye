        ...
        <div class="card">
          ...
          <hr>
            <div class="card-body">
              ...
              <p class="card-text"><i <i class="fas fa-gamepad"></i> Type de jeu</p>
              <p class="card-text"><i <i class="fas fa-map-marker-alt"></i> Lieu</p>
              <p class="card-text"><i <i class="fas fa-users"></i> Age</p>
